    ...
    return (
        <>
            <div className='mb-2 slide-in-top flex flex-col items-start sm:items-center relative z-0'>
                ...
                <button className={`bg-[#5CF2AC] text-[#0D0D0D] px-4 py-2 rounded-2xl hover:text-white hover:bg-[#6638A6] transition-colors duration-500 flex items-center shadow ${loadingOneIdea? 'pointer-events-none': 'pointer-events-auto'}`} onClick={obtainNewElement}>
